...
import { PlayerStatsSkeleton } from '../../components/skeleton/PlayerStatSkeleton';
    ...
    <div className='min-h-screen bg-[#1a1f2e] text-white'>
      <div className='container mx-auto py-8 px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {isLoading
            ? [...Array(PLAYER_IDS.length)].map((_, index) => (
                <PlayerStatsSkeleton key={index} />
              ))
                    ...
                    <Tabs defaultValue='overview' className='w-full'>
                      ...
                      <TabsContent value='champions' className='p-4'>
                        <div className='space-y-4'>
                          {player.stats.champions.map((champion) => (
                            <div
                              key={champion.name}
